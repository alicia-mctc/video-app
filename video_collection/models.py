...
class Video(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        # https://www.youtube.com/watch?v12345678
        # where 12345678 is the video ID
        #extract the video id from a youtube url, prevent save if not valid YouTube URL
        #  or id ID is not found in URL

        try: 
            url_components = parse.urlparse(self.url)
            if url_components.scheme != 'http' or url_components.netloc != 'www.youtube.com' or url_components.path != 'watch':
    ...
    def __str__(self):
        ...
        return f'ID: {self.pk}, Name: {self.name}, URL: {self.url}, Video ID: {self.video.id}, Notes: {self.notes[:200]}'